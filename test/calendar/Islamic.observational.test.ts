...
import { IslamicObservationalCalendar as cal } from "../../src/calendar/IslamicObservationalCalendar";

import { describe, expect, it } from "vite-plus/test";

const dates = [
  { jdn: 1507231.5, rataDie: -214192, date: { year: -1245, month: 12, day: 11 } },
  { jdn: 1660037.5, rataDie: -61387, date: { year: -813, month: 2, day: 25 } },
  { jdn: 1746893.5, rataDie: 25469, date: { year: -568, month: 4, day: 2 } },
  { jdn: 1770641.5, rataDie: 49217, date: { year: -501, month: 4, day: 7 } },
  ...
  { jdn: 2191584.5, rataDie: 470160, date: { year: 687, month: 2, day: 21 } },
  { jdn: 2195261.5, rataDie: 473837, date: { year: 697, month: 7, day: 7 } },
  { jdn: 2229274.5, rataDie: 507850, date: { year: 793, month: 6, day: 30 } },
  { jdn: 2245580.5, rataDie: 524156, date: { year: 839, month: 7, day: 6 } },
  { jdn: 2266100.5, rataDie: 544676, date: { year: 897, month: 6, day: 2 } },
  ...
  { jdn: 2334848.5, rataDie: 613424, date: { year: 1091, month: 6, day: 3 } },
