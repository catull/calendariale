...
import { CalendarDateValidationException, LeapMonthCalendarDate } from './core';
...
export class ChineseCalendarDate extends LeapMonthCalendarDate {
  ...
  */
  ...
  private static chineseWinterSolsticeOnOrBefore(fixed: number): number {
    ...
    return next(Math.floor(approx) - 1, (day: number) => Season.WINTER < solarLongitude(ChineseCalendarDate.midnightInChina(1 + day)));
  }
