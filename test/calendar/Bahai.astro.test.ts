...
import { BahaiAstroCalendar as cal } from "../../src/calendar/BahaiAstroCalendar";
...
const dates = [
  {
    jdn: 1507231.5,
    rataDie: -214192,
    date: { kullIShay: -6, vahid: 6, year: 3, month: 7, day: 11 },
  },
  {
    jdn: 1660037.5,
    rataDie: -61387,
  ...
  { jdn: 1770641.5, rataDie: 49217, date: { kullIShay: -4, vahid: 6, year: 2, month: 11, day: 6 } },
  {
    jdn: 1892731.5,
    rataDie: 171307,
    date: { kullIShay: -3, vahid: 4, year: 13, month: 16, day: 10 },
  },
  {
    jdn: 1931579.5,
    rataDie: 210155,
    date: { kullIShay: -3, vahid: 10, year: 6, month: 4, day: 5 },
  },
  {
    jdn: 1974851.5,
    rataDie: 253427,
  ...
  },
  {
    jdn: 2121509.5,
    rataDie: 400085,
    date: { kullIShay: -2, vahid: 18, year: 13, month: 4, day: 9 },
  },
  {
    jdn: 2155779.5,
    rataDie: 434355,
  ...
  },
  {
    jdn: 2174029.5,
    rataDie: 452605,
    date: { kullIShay: -1, vahid: 7, year: 4, month: 19, day: 10 },
  },
  {
    jdn: 2191584.5,
    rataDie: 470160,
    date: { kullIShay: -1, vahid: 9, year: 15, month: 1, day: 14 },
  },
  {
    jdn: 2195261.5,
    rataDie: 473837,
    date: { kullIShay: -1, vahid: 10, year: 6, month: 3, day: 1 },
  },
  {
    jdn: 2229274.5,
    rataDie: 507850,
  ...
  { jdn: 2334848.5, rataDie: 613424, date: { kullIShay: 0, vahid: 11, year: 8, month: 6, day: 8 } },
  {
    jdn: 2348020.5,
    rataDie: 626596,
    date: { kullIShay: 0, vahid: 13, year: 6, month: 7, day: 13 },
  },
  {
    jdn: 2366978.5,
    rataDie: 645554,
    date: { kullIShay: 0, vahid: 16, year: 1, month: 5, day: 16 },
  },
  {
    jdn: 2385648.5,
    rataDie: 664224,
  ...
  },
  {
    jdn: 2448698.5,
    rataDie: 727274,
    date: { kullIShay: 1, vahid: 8, year: 15, month: 19, day: 17 },
  },
  {
    jdn: 2450138.5,
    rataDie: 728714,
  ...
  },
  {
    jdn: 2465737.5,
    rataDie: 744313,
    date: { kullIShay: 1, vahid: 11, year: 5, month: 13, day: 8 },
  },
...
describe("bahai Astro calendar spec", () => {
  ...
  it("should determine whether a Bahai Astro year is a leap year", () => {
