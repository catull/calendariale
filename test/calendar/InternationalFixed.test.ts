...
import { InternationalFixedCalendar as cal } from "../../src/calendar/InternationalFixedCalendar";

import { describe, expect, it } from "vite-plus/test";

const dates = [
  { jdn: 1507231.5, rataDie: -214192, date: { year: -586, month: 8, day: 9 } },
  { jdn: 1660037.5, rataDie: -61387, date: { year: -168, month: 13, day: 3 } },
  ...
  { jdn: 2155779.5, rataDie: 434355, date: { year: 1190, month: 3, day: 26 } },
  { jdn: 2174029.5, rataDie: 452605, date: { year: 1240, month: 3, day: 14 } },
  { jdn: 2191584.5, rataDie: 470160, date: { year: 1288, month: 4, day: 9 } },
  { jdn: 2195261.5, rataDie: 473837, date: { year: 1298, month: 5, day: 5 } },
  { jdn: 2229274.5, rataDie: 507850, date: { year: 1391, month: 6, day: 23 } },
  { jdn: 2245580.5, rataDie: 524156, date: { year: 1436, month: 2, day: 6 } },
  { jdn: 2266100.5, rataDie: 544676, date: { year: 1492, month: 4, day: 16 } },
  { jdn: 2288542.5, rataDie: 567118, date: { year: 1553, month: 10, day: 10 } },
  { jdn: 2290901.5, rataDie: 569477, date: { year: 1560, month: 3, day: 9 } },
  { jdn: 2323140.5, rataDie: 601716, date: { year: 1648, month: 6, day: 22 } },
  { jdn: 2334848.5, rataDie: 613424, date: { year: 1680, month: 7, day: 13 } },
  { jdn: 2348020.5, rataDie: 626596, date: { year: 1716, month: 8, day: 9 } },
  { jdn: 2366978.5, rataDie: 645554, date: { year: 1768, month: 7, day: 2 } },
  { jdn: 2385648.5, rataDie: 664224, date: { year: 1819, month: 8, day: 18 } },
  { jdn: 2392825.5, rataDie: 671401, date: { year: 1839, month: 4, day: 2 } },
  { jdn: 2416223.5, rataDie: 694799, date: { year: 1903, month: 4, day: 25 } },
  { jdn: 2425848.5, rataDie: 704424, date: { year: 1929, month: 9, day: 13 } },
  { jdn: 2430266.5, rataDie: 708842, date: { year: 1941, month: 10, day: 20 } },
  { jdn: 2430833.5, rataDie: 709409, date: { year: 1943, month: 4, day: 25 } },
...
describe("international fixed calendar spec", () => {
  it("should convert an International Fixed date to Julian day number (JDN)", () => {
  ...
  it("should convert a Julian day number (JDN) to an International Fixed date", () => {
    dates.forEach(({ jdn, date }) => {
  ...
  it("should determine whether an International Fixed year is a leap year", () => {
