...
export class Symmetry010CalendarDate extends LeapCalendarDate {
  ...
  public static fromJdn(jdn: number): Symmetry010CalendarDate {
    ...
    return new Symmetry010CalendarDate(jdn, year, month, day);
  }
  ...
  constructor(jdn: number, year: number, month: number, day: number) {
    super(jdn, year, month, day, Symmetry010CalendarDate.isLeapYear(year));
  }
