...
import { IslamicUmmAlQuraCalendar as cal } from "../../src/calendar/IslamicUmmAlQuraCalendar";
...
describe("islamic Umm al-Qura calendar spec", () => {
  ...
  it("should determine whether an Islamic Umm al-Qura year is a leap year", () => {
