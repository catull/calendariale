...
const dates = [
  ...
  { jdn: 1931579.5, date: { year:  576, month:  6, event:  RomanEvent.KALENDS, count: 15, leap: false } },
  { jdn: 1974851.5, date: { year:  694, month: 11, event:  RomanEvent.IDES,    count:  7, leap: false } },
  { jdn: 2091164.5, date: { year: 1013, month:  5, event:  RomanEvent.KALENDS, count: 13, leap: false } },
  { jdn: 2121509.5, date: { year: 1096, month:  6, event:  RomanEvent.KALENDS, count: 15, leap: false } },
  { jdn: 2155779.5, date: { year: 1190, month:  4, event:  RomanEvent.KALENDS, count: 17, leap: false } },
  { jdn: 2174029.5, date: { year: 1240, month:  3, event:  RomanEvent.NONES,   count:  5, leap: false } },
  { jdn: 2191584.5, date: { year: 1288, month:  4, event:  RomanEvent.KALENDS, count:  7, leap: false } },
  { jdn: 2195261.5, date: { year: 1298, month:  5, event:  RomanEvent.KALENDS, count: 12, leap: false } },
  { jdn: 2229274.5, date: { year: 1391, month:  6, event:  RomanEvent.NONES,   count:  2, leap: false } },
  { jdn: 2245580.5, date: { year: 1436, month:  2, event:  RomanEvent.KALENDS, count:  8, leap: false } },
  { jdn: 2266100.5, date: { year: 1492, month:  4, event:  RomanEvent.KALENDS, count:  2, leap: false } },
  { jdn: 2288542.5, date: { year: 1553, month:  9, event:  RomanEvent.IDES,    count:  5, leap: false } },
  { jdn: 2290901.5, date: { year: 1560, month:  3, event:  RomanEvent.KALENDS, count:  6, leap: false } },
  { jdn: 2323140.5, date: { year: 1648, month:  6, event:  RomanEvent.KALENDS, count:  2, leap: false } },
  { jdn: 2334848.5, date: { year: 1680, month:  7, event:  RomanEvent.KALENDS, count: 12, leap: false } },
  { jdn: 2348020.5, date: { year: 1716, month:  7, event:  RomanEvent.IDES,    count:  3, leap: false } },
  { jdn: 2366978.5, date: { year: 1768, month:  6, event:  RomanEvent.IDES,    count:  6, leap: false } },
  { jdn: 2385648.5, date: { year: 1819, month:  8, event:  RomanEvent.KALENDS, count: 12, leap: false } },
  { jdn: 2392825.5, date: { year: 1839, month:  3, event:  RomanEvent.IDES,    count:  1, leap: false } },
  { jdn: 2416223.5, date: { year: 1903, month:  4, event:  RomanEvent.IDES,    count:  8, leap: false } },
  { jdn: 2425848.5, date: { year: 1929, month:  8, event:  RomanEvent.IDES,    count:  2, leap: false } },
  { jdn: 2430266.5, date: { year: 1941, month: 10, event:  RomanEvent.KALENDS, count: 16, leap: false } },
  { jdn: 2430833.5, date: { year: 1943, month:  4, event:  RomanEvent.IDES,    count:  8, leap: false } },
  { jdn: 2431004.5, date: { year: 1943, month: 10, event:  RomanEvent.KALENDS, count:  8, leap: false } },
  { jdn: 2448698.5, date: { year: 1992, month:  3, event:  RomanEvent.NONES,   count:  4, leap: false } },
  { jdn: 2450138.5, date: { year: 1996, month:  2, event:  RomanEvent.IDES,    count:  2, leap: false } },
  { jdn: 2465737.5, date: { year: 2038, month: 11, event:  RomanEvent.KALENDS, count:  5, leap: false } },
  { jdn: 2486076.5, date: { year: 2094, month:  7, event:  RomanEvent.NONES,   count:  3, leap: false } },
];
